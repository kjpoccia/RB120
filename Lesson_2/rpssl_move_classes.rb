...
class Rock < Move
  def >(other_move)
    %w(scissors, lizard).include?(other_move)
  end

  def <(other_move)
    %w(paper, spock).include?(other_move)
  end
end

class Paper < Move
  def >(other_move)
    %w(spock, rock).include?(other_move)
  end
...
class Scissors < Move
  def >(other_move)
    %w(paper, lizard).include?(other_move)
  end

  def <(other_move)
    %w(rock, spock).include?(other_move)
  end
end

class Spock < Move
  def >(other_move)
    %w(scissors, rock).include?(other_move)
  end
